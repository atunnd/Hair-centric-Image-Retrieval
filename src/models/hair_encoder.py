...
class HairEncoder:
    """Hair Image Encoder using Vision Transformer for feature extraction and retrieval"""
    
    def __init__(self, ckpt_path, model_name="vit_base_patch16", device=None):
        """
        Initialize the HairEncoder
...
class HairRetrievalVisualizer:
    ...
    def visualize_multiple_queries(self, hair_encoder, embeddings, paths, num_queries=5, top_k=5, random_seed=42):
        ...
        combined_vis_path = os.path.join(self.vis_save_dir, "combined_retrieval_results.png")
