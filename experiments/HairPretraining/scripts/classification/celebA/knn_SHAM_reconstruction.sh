...
python knn_classification.py \
  ...
  --mode SHAM \
  --model vit_b_16 \
  --checkpoint_path /datastore/dragonzakura/QuocAnh/Composed-Image-Retrieval/experiments/HairPretraining/output_dir/SHAM_vit_b_16_reconstruction_multi_view_decoder_7_layers/model_ckpt_latest.pth \
  --num_workers 8 \
  --device cuda:1 \
  --batch_size 256 \
