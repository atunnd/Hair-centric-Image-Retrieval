...
python knn_classification.py \
  ...
  --mode SHAM \
  --model vit_b_16 \
  --checkpoint_path /mnt/mmlab2024nas/thanhnd_student/QuocAnh/FCIR/Baselines/Composed-Image-Retrieval/experiments/HairPretraining/output_dir/SHAM_vit_b_16_embedding/model_ckpt_219.pth \
  --seed 42 \
  --num_workers 8 \
  --device cuda \
  --batch_size 256 \
